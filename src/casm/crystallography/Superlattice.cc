...
namespace CASM {
  namespace xtal {
    Superlattice::Superlattice(const Lattice &tiling_unit, const Lattice &superlattice):
      ...
      m_transformation_matrix_to_super(xtal::make_transformation_matrix_to_super(this->prim_lattice(), this->superlattice(), TOL)),
    ...
    Superlattice Superlattice::smooth_prim(const Lattice &tiling_unit, const Lattice &superlattice) {
      ...
      Eigen::Matrix3d trans_mat_inverse = result_superlattice.transformation_matrix_to_super().cast<double>().inverse();
