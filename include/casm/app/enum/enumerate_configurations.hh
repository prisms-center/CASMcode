...
struct ConfigEnumOptions {
  ConfigEnumOptions(PrimClex const &primclex) : primclex_ptr(&primclex) {}
...
template <typename MakeEnumeratorFunction, typename InputNameValuePairIterator,
          typename ConfigEnumDataType>
void enumerate_configurations(
    PrimClex const &primclex, ConfigEnumOptions const &options,
