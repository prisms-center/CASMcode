...
namespace notstd {
  ...
  template <typename F>
  /* using first_argument_type = std::decay_t<typename function_traits<F>::template arg<0>::type>; */
  using first_argument_type = typename std::decay<typename function_traits<F>::template arg<0>::type>::type;
  template <typename F>
  /* using second_argument_type = std::decay_t<typename function_traits<F>::template arg<1>::type>; */
