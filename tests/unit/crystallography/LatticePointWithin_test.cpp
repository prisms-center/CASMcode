...
namespace {
  ...
  xtal::LatticePointWithin::matrix_type transformation_matrix() {
...
TEST(LatticePointWithinTest, construct_via_int_transformation) {
  ...
  xtal::LatticePointWithin bring_within(trans_mat);
}
...
TEST(LatticePointWithinTest, construct_via_superlattice) {
  ...
  xtal::LatticePointWithin bring_within(::fcc_lattice(), fcc_superlattice);
}
...
TEST(LatticePointWithinTest, construct_via_bad_superlattice) {
  ...
  bool good_catch = false;
  try {
    xtal::LatticePointWithin bring_within(::bcc_lattice(), fcc_superlattice);
  }
  catch(const std::runtime_error &e) {
    good_catch = true;
  }
