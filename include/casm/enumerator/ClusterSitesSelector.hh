...
// /// Functor class to select sites on ConfigEnumInput for any supported orbit
// type
// ///
...
// /// // ClusterSpecs, which can generate "within_scel" or "prim_periodic"
// orbits
...
// ///   auto selector = make_cluster_sites_selector(input,
// std::back_inserter(with_cluster_sites));
// ///   // This handles checking what type of orbits ClusterSpecs generates,
// making them, and
...
// /// //     with_cluster_sites.size() == initial_config_enum_input.size() *
// orbits.size()
// /// \endcode
// ///
// template<typename Inserter>
...
// public:
//   ClusterSitesSelector(ConfigEnumInput const &_reference_config_enum_input,
//   Inserter _inserter);
//
...
// /// Create ConfigEnumInput with unique cluster sites selected, starting from
// "within_scel" orbits template<typename Inserter> template<> void
// ClusterSitesSelector<Inserter>::operator()<WithinScelIntegralClusterOrbit>(std::vector<WithinScelIntegralClusterOrbit>
// const &orbits) const;
//
// /// Create ConfigEnumInput with unique cluster sites selected, starting from
// "prim_periodic" orbits template<typename Inserter> template<> void
// ClusterSitesSelector<Inserter>::operator()<PrimPeriodicIntegralClusterOrbit>(std::vector<PrimPeriodicIntegralClusterOrbit>
// const &orbits) const;
