...
IntegralCluster::IntegralCluster(PrimType const &prim) : m_prim_ptr(&prim) {}
...
///   Object &apply(const Transform &transformation, Object &obj, const Args
///   &... args);
template <>
IntegralCluster &apply(SymOp const &op, IntegralCluster &clust,
