...
/// Generate an orbit of unique Element generated by a group of SymOp or
/// PermuteIterator
///
/// SimpleOrbit is similar to Orbit, but does not maintain the generating group
/// or equivalence map and element sorting is not based on the equivalence map.
///
