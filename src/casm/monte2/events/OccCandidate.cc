...
Monte2::OccCandidate jsonConstructor<Monte2::OccCandidate>::from_json(
    const jsonParser &json, const Monte2::Conversions &convert) {
  return Monte2::OccCandidate(
      json["asym"].get<Index>(),
      convert.species_index(json["spec"].get<std::string>()));
}

Monte2::OccSwap jsonConstructor<Monte2::OccSwap>::from_json(
    const jsonParser &json, const Monte2::Conversions &convert) {
  return Monte2::OccSwap(
      jsonConstructor<Monte2::OccCandidate>::from_json(json[0], convert),
      jsonConstructor<Monte2::OccCandidate>::from_json(json[1], convert));
}
