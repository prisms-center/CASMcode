...
namespace CASM {
  ...
  public:
    ...
    DatumFormatterAdapter(const std::string &_name,
    ...
    DatumFormatterAdapter(adapter::Adapter<InternalType, ExternalType> _adapt,
                          BaseDatumFormatter<InternalType> const &_base_formatter):
      BaseDatumFormatter<ExternalType>(_base_formatter.name(), _base_formatter.description()),
      m_adapt(_adapt),
      m_base_ptr(notstd::clone(_base_formatter)) {}
    ...
    std::unique_ptr<DatumFormatterAdapter<ExternalType, InternalType> > clone() const {
      return std::unique_ptr<DatumFormatterAdapter<ExternalType, InternalType> >(this->_clone());
    }
  ...
  DatumFormatterAdapter<ExternalType, InternalType> make_datum_formatter_adapter(
    ...
    return DatumFormatterAdapter<ExternalType, InternalType> {
      adapter::Adapter<InternalType, ExternalType>(),
      _base_formatter
    };
  }
