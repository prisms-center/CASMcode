...
/// \brief Print informational message and throw exception if input data is not
/// valid
...
///
/// - If the points in the provided configuration selection do not span the
/// entire composition
///   space, a principle component analysis identifies the subspace that is
///   spanned and this matrix rotates points into that subspace
...
///
/// - Calculated from the normal of the provided facet, so units depend on
/// composition/energy space
...
/// configuration in full comp/energy space
...
/// \brief The distance a point in the reduced composition/energy space is above
/// the hull along the energy axis
