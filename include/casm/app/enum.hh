...
///
/// The `enum` command provides access to methods that construct and save
/// Supercells or Configurations.
///
...
/// - Insert the interface into the standard enumerator map by adding it to the
/// implementation
///   of `make_standard_enumerator_interfaces`.
///
/// Custom enumeration methods can also be implemented via plugins. TODO: Full
/// description.
