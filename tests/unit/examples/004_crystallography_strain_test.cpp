...
// ---------------
//
// StrainConverter enables converting between the deformation tensor and various strain metrics,
// and unrolling the strain metric as a vector. The StrainConverter is constructed with "mode_name"
// (std::string) indicating one of several possible strain metrics (strain::METRIC):
