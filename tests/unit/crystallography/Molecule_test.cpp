...
BOOST_AUTO_TEST_CASE(SpecieTest1) {
  AtomSpecie specie_a("A");
  AtomSpecie specie_a2("A");
  AtomSpecie specie_b("B");

  BOOST_CHECK_EQUAL(specie_a.name(), "A");
  BOOST_CHECK_EQUAL(specie_a2.name(), "A");
  BOOST_CHECK_EQUAL(specie_b.name(), "B");
  BOOST_CHECK_EQUAL(specie_a < specie_a2, false);
  BOOST_CHECK_EQUAL(specie_a == specie_a2, true);
  BOOST_CHECK_EQUAL(specie_a < specie_b, true);
  BOOST_CHECK_EQUAL(specie_a > specie_b, false);
  BOOST_CHECK_EQUAL(specie_a == specie_b, false);
...
BOOST_AUTO_TEST_CASE(AtomPositionTest1) {
  ...
  AtomPosition atom_pos_a(vec, specie_a);
  AtomPosition atom_pos_a2(vec, "A");
  AtomPosition atom_pos_b(vec, "B");

  BOOST_CHECK_EQUAL(atom_pos_a.name(), "A");
  BOOST_CHECK_EQUAL(atom_pos_a.specie() == specie_a, true);
  BOOST_CHECK_EQUAL(atom_pos_a2.specie() == specie_a, true);
  BOOST_CHECK_EQUAL(atom_pos_b.specie() != specie_a, true);
...
BOOST_AUTO_TEST_CASE(MoleculeTest1) {
  ...
  BOOST_CHECK_EQUAL(mol_a.atom(0).specie() == AtomSpecie("A"), true);
  ...
  BOOST_CHECK_EQUAL(mol_h2o.atoms().at(0).specie() == AtomSpecie("H"), true);
  BOOST_CHECK_EQUAL(mol_h2o.atoms().at(1).specie() == AtomSpecie("H"), true);
  BOOST_CHECK_EQUAL(mol_h2o.atoms().at(2).specie() == AtomSpecie("O"), true);
  BOOST_CHECK_EQUAL(mol_h2o.atom(0).specie() == AtomSpecie("H"), true);
  BOOST_CHECK_EQUAL(mol_h2o.atom(1).specie() == AtomSpecie("H"), true);
  BOOST_CHECK_EQUAL(mol_h2o.atom(2).specie() == AtomSpecie("O"), true);
