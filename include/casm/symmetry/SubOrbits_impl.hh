...
/// \param invariant_subgroup_begin, invariant_subgroup_end The subgroup of
/// [group_begin, group_end)
///        that leaves element invariant as determined by "sym_compare"
/// \param sym_compare SymCompareType functor for comparing elements and
/// applying symmetry \param result Output iterator outputs sub-orbit generating
/// elements w.r.t. [subgroup_begin, subgroup_end)
///
