...
// std::vector<PermuteIterator> make_invariant_subgroup(const Element &element,
...
//       auto trans_it = scel.sym_info().permute_it(0,
//       xtal::UnitCell::from_coordinate(coord)); result.push_back(trans_it *
//       it);
//     }
//     ++it;
//   }
//   if(result[0].sym_op().index() != 0) {
//     throw std::runtime_error("Error in make_invariant_subgroup (2): First
//     element is not identity.");
//   }
//   return result;
// }
...
//   }
//   if(result[0].sym_op().index() != 0) {
//     throw std::runtime_error("Error in make_invariant_subgroup (3): First
//     element is not identity.");
//   }
//   return result;
// }
...
// unchanged
// ///
// /// \param scel_A Supercell find subgroup of permutations that leave scel_A
// unchanged
...
//     Index master_fg_index =
//     scel_B_fg[scel_B_it.factor_group_index()].index(); return std::any_of(
//              scel_A_fg.begin(),
//              scel_A_fg.end(),
//     [&](const SymOp & op) {
...
//     throw std::runtime_error("Error in make_invariant_subgroup (4): First
//     element is not identity.");
//   }
//   return subgroup;
// }
