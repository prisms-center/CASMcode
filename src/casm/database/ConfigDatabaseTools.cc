...
namespace CASM {
  namespace DB {
    ...
    /// - The canonical Supercell will have a `PrimClex const*` (in the future this will be
    ///   deprecated)
    Configuration in_canonical_supercell(
      ...
      Supercell const &canon_supercell_of_configuration = *(make_canonical_and_insert(
                                                              primclex,
                                                              configuration.supercell().sym_info().supercell_lattice(),
                                                              supercell_db).first);

      return fill_supercell(configuration, canon_supercell_of_configuration).canonical_form();
    }
    ...
    /// - The canonical Supercell will have a `PrimClex const*` (this will be deprecated)
