...
namespace CASM {
  ...
  xtal::DoFSet &apply(const xtal::SymOp &_op, xtal::DoFSet &_dof) {
  ...
  xtal::DoFSet copy_apply(const xtal::SymOp &op, const xtal::DoFSet &_dof) {
    xtal::DoFSet result(_dof);
    return apply(op, result);
  }

  //********************************************************************

  xtal::DoFSet jsonConstructor<xtal::DoFSet>::from_json(const jsonParser &json, xtal::DoFSet::BasicTraits const &_type) {
    xtal::DoFSet value(_type);
