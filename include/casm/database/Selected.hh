...
/// \brief Returns true if configuration is specified in given selection
/// (default: MASTER)
///
...
class Selected : public BooleanAttribute<ObjType> {
 public:
  Selected()
      : BooleanAttribute<ObjType>("selected_in",
                                  "Returns true if object is specified in "
                                  "given selection (default MASTER). "
                                  "Ex: 'selected_in(myselection.txt)'") {}

  explicit Selected(const Selection<ObjType> &_selection)
      : BooleanAttribute<ObjType>("selected_in",
                                  "Returns true if configuration is specified "
                                  "in given selection (default MASTER). "
                                  "Ex: 'selected_in(myselection.txt)'"),
