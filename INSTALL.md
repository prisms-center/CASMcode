...
On subsequent runs, steps (1) and (2) will be skipped if `configure` exists. To take into account the addition or delectino or files, or to re-configure, do: `rm configure` and re-run.
