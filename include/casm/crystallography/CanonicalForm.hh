  ...
  namespace xtal {
    ...
    namespace canonical {
      ...
      Lattice equivalent(Lattice const &in_lat, ExternSymOpVector const &point_grp, double compare_tol) {
        return equivalent(in_lat, adapter::Adapter<SymOpVector, ExternSymOpVector>()(point_grp), compare_tol);
      }
      ...
      Lattice equivalent(Lattice const &in_lat, ExternSymOpVector const &g) {
        return equivalent(in_lat, adapter::Adapter<SymOpVector, ExternSymOpVector>()(g));
      }
      ...
      Index operation_index(const Lattice &lat, ExternSymOpVector const &g) {
        return operation_index(lat, adapter::Adapter<SymOpVector, ExternSymOpVector>()(g));
      }
