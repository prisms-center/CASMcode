#ifndef CASM_monte2_OccCandidate
#define CASM_monte2_OccCandidate
...
template <>
struct jsonConstructor<Monte2::OccCandidate> {
  static Monte2::OccCandidate from_json(const jsonParser &json,
                                        const Monte2::Conversions &convert);
};

template <>
struct jsonConstructor<Monte2::OccSwap> {
  static Monte2::OccSwap from_json(const jsonParser &json,
                                   const Monte2::Conversions &convert);
};
}  // namespace CASM
