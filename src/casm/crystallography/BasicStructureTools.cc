...
/// structures!
xtal::SymOpVector
make_factor_group_from_point_group(const xtal::BasicStructure &struc,
                                   const xtal::SymOpVector &point_group,
...
std::pair<xtal::BasicStructure, xtal::SymOpVector>
make_primitive_factor_group(const xtal::BasicStructure &non_primitive_struc,
                            double tol) {
