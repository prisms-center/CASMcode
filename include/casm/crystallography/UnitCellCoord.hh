...
namespace CASM {
  ...
  /// \brief Add UnitCell to UnitCellCoord 
  inline UnitCellCoord operator+(UnitCell frac, UnitCellCoord site){return site += frac;}
  
  /// \brief Add UnitCell to UnitCellCoord
  inline UnitCellCoord operator+(UnitCellCoord site, UnitCell frac){return site += frac;}
  ...
  /// \brief Compare UnitCellCoord 
  inline bool operator>(const UnitCellCoord &A, const UnitCellCoord &B){return B < A;}
  
  /// \brief Compare UnitCellCoord 
  inline bool operator<=(const UnitCellCoord &A, const UnitCellCoord &B){return !(A > B);}
