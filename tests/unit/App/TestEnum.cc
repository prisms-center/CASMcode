// This is an example enumerator plugin implementation. It is a copy of
// ConfigEnumAllOccupations, with the name changed to TestEnum. For a plugin,
// the primary requirements are:
// - Must have a source file named "MethodName.cc" in the enumerator plugins
// directory
// - Must have an interface generating function. It should be:
//   - An `extern "C"` function
//   - With name and signature `CASM::EnumInterfaceBase
//   *make_<MethodName>_interface()`
// - Placing declarations in a header file is optional
// - EnumInterfaceBase is defined in "casm/app/enum/EnumInterface.hh"
// - See the standard interfaces implemented in `casm/app/enum/methods` for
// examples
...
std::string TestEnum::name() const { return enumerator_name; }
...
class TestEnumInterface : public EnumInterfaceBase {
 ...
 public:
  std::string desc() const override {
    ...
    std::string examples =
        "  Examples:\n"
        "    To enumerate all occupations in supercells up to and including "
        "size 4:\n"
  ...
  std::string name() const override { return TestEnum::enumerator_name; }
  ...
  void run(PrimClex &primclex, jsonParser const &json_options,
    ...
    auto options_parser_ptr = parser.parse_as<ConfigEnumOptions>(
        TestEnum::enumerator_name, primclex,
