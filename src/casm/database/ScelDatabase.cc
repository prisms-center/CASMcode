...
Database<Supercell>::iterator Database<Supercell>::find(
...
Database<Supercell>::iterator Database<Supercell>::_iterator(
    base_iterator base_it) const {
  return iterator(
      DatabaseSetIterator<Supercell, Database<Supercell> >(base_it));
}
