...
namespace CASM {
  namespace xtal {
    ...
    bool SymOpPeriodicCompare_f::operator()(const SymOp &lhs, const SymOp& rhs) const {
      ...
      xtal::Coordinate this_translation_coord(lhs.translation, this->m_periodicity_lattice, CART);
      xtal::Coordinate match_translation_coord(rhs.translation, this->m_periodicity_lattice, CART);
