...
/// \brief Samples all requested property data, and stores pass and step number
/// sample was taken at
...
///
/// - equil_samples is the number of samples required for all samplers that must
/// equilibrate to equilibrate
...
/// - If equilibrated, checks if the required convergence has occured for all
/// sampler that must converge
/// - Convergence is checked only for the range of observations that were taken
/// after all
