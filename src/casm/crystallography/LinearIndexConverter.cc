...
namespace CASM {
  namespace xtal {
    ...
    void UnitCellCoordIndexConverter::_throw_if_bad_basis_sites_in_prim(int basis_sites_in_prim) {
    ...
    void UnitCellCoordIndexConverter::_throw_if_incompatible_bijk(const UnitCellCoord &bijk) const {
    ...
    UnitCellCoord UnitCellCoordIndexConverter::bring_within(const UnitCellCoord &bijk) const {
