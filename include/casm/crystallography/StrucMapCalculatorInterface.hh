...
public:
  ...
  translations(MappingNode const &_node,
  ...
  virtual SimpleStructure
  resolve_setting(MappingNode const &_node,
  ...
  /// \brief Make an exact copy of the calculator (including any initialized
  /// members)
  std::unique_ptr<StrucMapCalculatorInterface>
  quasi_clone(SimpleStructure _parent,
              SymOpVector const &_factor_group = {SymOp::identity()},
              SimpleStructure::SpeciesMode _species_mode =
                  SimpleStructure::SpeciesMode::ATOM,
...
private:
  ...
  /// members)
  virtual StrucMapCalculatorInterface *
  _quasi_clone(SimpleStructure _parent,
               SymOpVector const &_factor_group = {SymOp::identity()},
               SimpleStructure::SpeciesMode _species_mode =
                   SimpleStructure::SpeciesMode::ATOM,
