...
namespace CASM {
  namespace strain {
    /**
     * Enumerates different types of available strain metrics, which can be used to specify
     * conversion between deformation tensors and the desired metric:
     *
    ...
    /// Convert a strain metric tensor to the deformation tensor, where the given strain
    /// metric is specified with the template parameter. For example, to convert a
    /// Green Lagrange strain tensor GL to the deformation tensor F:
