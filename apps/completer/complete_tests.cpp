...
int main(int argc, char *argv[]) {
  ...
  //Generate a fake value set of query options description
  ...
  Completer::add_query_options(dumbquery, qstr, qpth, qvec, qvec, qvec, qbool, qbool, qbool, qbool);
  Option query_opts("query", dumbquery);
