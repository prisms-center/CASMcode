...
class GrandCanonicalEvent {
 public:
  ...
  /// \brief Access change in number of species per supercell. Order as in
  ...
  /// \brief Return change in number of species in supercell. Order as in
  /// CompositionConverter::components().
  long int dN(size_type species_type_index) const;

  /// \brief Set change in (extensive) potential energy, dEpot = dEf -
  /// sum_i(Nunit * param_chem_pot_i * dcomp_x_i)
...
inline double GrandCanonicalEvent::dEf() const { return m_dEf; }

/// \brief Access change in number of all species (extensive). Order as in
/// CompositionConverter::components().
inline Eigen::VectorXl &GrandCanonicalEvent::dN() { return m_dN; }
...
inline void GrandCanonicalEvent::set_dN(size_type species_type_index,
                                        long int dNi) {
...
/// \brief Set the change in potential energy: dEpot = dEf - sum_i(Nunit *
/// param_chem_pot_i * dcomp_x_i)
inline void GrandCanonicalEvent::set_dEpot(double dEpot) { m_dEpot = dEpot; }

/// \brief Return change in potential energy: dEpot = dEf - sum_i(Nunit *
/// param_chem_pot_i * dcomp_x_i)
inline double GrandCanonicalEvent::dEpot() const { return m_dEpot; }

/// \brief Access the changes in correlations associated with this event
inline Eigen::VectorXd &GrandCanonicalEvent::dCorr() { return m_dCorr; }
...
/// \brief Access the occupational modification for this event
inline OccMod &GrandCanonicalEvent::occupational_change() { return m_occ_mod; }
