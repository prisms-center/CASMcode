...
namespace CASM {
  ...
  bool PolynomialFunction::_accept(const FunctionVisitor &visitor, BasisSet const *home_basis_ptr/*=NULL*/) {
  ...
  void PolynomialFunction::fill_dispatch_table() {
    ...
    Function::operation_table[Variable::sclass_ID()][sclass_ID()] = NULL;
