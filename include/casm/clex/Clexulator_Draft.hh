...
class Clexulator {
 ...
 public:
  int nlist_size() const { return m_nlist_N; };
  int supercell_size() const { return m_site_N; };
  void set_supercell_size(int _site_N){m_site_N = _site_N};
...
/** 5 of 6 Orbits **  Orbit: 3 0  Points: 3  Mult: 12  MinLength: 4.3301270
 * MaxLength: 5.0000000 **/
...
// ClustClust_W_X_Y -> W is number of sites, X is linear orbit index, Y is equiv
// index
