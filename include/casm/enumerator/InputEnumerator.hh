...
class InputEnumIteratorBase : public ValEnumIterator<ValueType, IsConst> {
 ...
 public:
  ...
  InputEnumIteratorBase(InputEnumeratorBase<ValueType, IsConst> &enumerator,
                        bool is_end)
      : ValEnumIterator<ValueType, IsConst>(enumerator),
        m_constructed_as_end(is_end) {}
 ...
 protected:
  ...
  bool _constructed_as_end() const { return m_constructed_as_end; }
 ...
 private:
  ...
  virtual reference dereference() const override { return _enum().current(); }

  /// boost::iterator_facade implementation
  virtual void increment() { _enum().increment(); }
...
class InputEnumIterator :
    ...
    public boost::iterator_facade<InputEnumIterator<ValueType, IsConst>,
                                  ValueType, std::input_iterator_tag,
                                  CASM_TMP::ConstSwitch<IsConst, ValueType> &,
                                  long> {
 public:
  typedef
      typename InputEnumIteratorBase<ValueType, IsConst>::step_type step_type;
  typedef ValueType value_type;
  typedef
      typename InputEnumIteratorBase<ValueType, IsConst>::reference reference;
...
class InputEnumerator {
 public:
  ...
  typedef
      typename InputEnumeratorBase<ValueType, IsConst>::value_type value_type;
