...
namespace CASM {
  ...
  */
  ...
  /*template<typename Container,
           ...
           typename Access = CASM_TMP::BracketAccess<Container, value_type, size_type>,
           typename Compare = CASM_TMP::MuchLessThan<value_type> >
  */
  ...
  public:
    ...
    BaseCounter(const Container &_initial,
                const Container &_final,
                const Container &_increment,
                Access _access = Access(),
                Compare _compare = Compare()) :
      m_access(_access), m_compare(_compare), m_initial(_initial), m_final(_final), m_increment(_increment),
      m_lower(_initial), m_upper(_initial), m_current(_initial), m_valid(_initial.size() != 0) {

      //_init();
    }

    /// \returns false if the Counter::current value has been incremented past the Counter::final
    ///
    bool valid() const {
      return m_valid;
    };
    ...
    const_value_iterator value_end() const {
      return const_value_iterator(static_cast<DerivedCounter const *>(this), size());
    }
  ...
  protected:
    ...
    ///
    /// \returns a const reference to the element 'index' in the current value of the Container
    ///
    ...
    ///
    /// \returns a non-const reference to the element 'index' in the current value of the Container
    ///
    ...
    ///
    /// \returns a const reference to the element 'index' in the initial value of the Container
    ///
    ...
    ///
    /// \returns a non-const reference to the element 'index' in the initial value of the Container
    ///
    ...
    ///
    /// \returns a const reference to the element 'index' in the final value of the Container
    ///
    ...
    ///
    /// \returns a non-const reference to the element 'index' in the final value of the Container
    ///
    ...
    ///
    /// \returns a const reference to the element 'index' in the increment value of the Container
    ///
    ...
    ///
    /// \returns a non-const reference to the element 'index' in the increment value of the Container
    ///
    ...
    ///
    /// \returns a const reference to the element 'index' in the upper value of the Container
    ///
    ...
    ///
    /// \returns a non-const reference to the element 'index' in the upper value of the Container
    ///
    ...
    ///
    /// \returns a const reference to the element 'index' in the lower value of the Container
    ///
    ...
    ///
    /// \returns a non-const reference to the element 'index' in the lower value of the Container
    ///
