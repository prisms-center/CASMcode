...
const std::multimap<Monte::ENSEMBLE, std::vector<std::string> >
    traits<Monte::ENSEMBLE>::strval = {
        {Monte::ENSEMBLE::GrandCanonical,
         {"GrandCanonical", "grand_canonical"}},
...
const std::multimap<Monte::METHOD, std::vector<std::string> >
    traits<Monte::METHOD>::strval = {
...
const std::multimap<Monte::SAMPLE_MODE, std::vector<std::string> >
    traits<Monte::SAMPLE_MODE>::strval = {
...
const std::multimap<Monte::DRIVE_MODE, std::vector<std::string> >
    traits<Monte::DRIVE_MODE>::strval = {
...
const std::multimap<Monte::ENUM_SAMPLE_MODE, std::vector<std::string> >
    traits<Monte::ENUM_SAMPLE_MODE>::strval = {
