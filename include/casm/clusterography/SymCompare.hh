...
namespace casm {
  ...
  class SymCompare {
    ...
    virtual bool intra_orbit_compare(const UnitCellCoordCluster& A, const UnitCellCoordCluster& B) const = 0;
    ...
    ///
    /// - Assumes elements are 'prepared' before being compared
    bool intra_orbit_equal(const UnitCellCoordCluster& A, const UnitCellCoordCluster& B) const {
    ...
    bool inter_orbit_compare(const UnitCellCoordCluster& A, const UnitCellCoordCluster& B) const = 0;
    ...
    ///
    /// - Assumes elements are in canonical form
    bool inter_orbit_equal(const UnitCellCoordCluster& A, const UnitCellCoordCluster& B) const {
  ...
  std::pair<Element, SymOpIterator> canonical_form(const Element& obj, SymCompare<Element>& compare, SymOpIterator begin, SymOpIterator end) {
    auto it = begin;
